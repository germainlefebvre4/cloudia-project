...
Create the service account (or equivalent) on your Cloud Provers platforms (such as Amazon Web Services, Google Cloud Platform, Microsoft Azure, etc.) and download the credentials file.
